...
\begin{abstract}
  ...
  were chosen to match the Cape Wind measurements of Archer \emph{et
    al.} with wind speeds of 5 m/s, 10 m/s, and 15 m/s at the 20m
...
model containing backscatter to favorably compare to the \fxnote{[Nate: define BASE]} BASE measurements, showing that
