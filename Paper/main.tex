...
\fxnote{This is the introduction from the abstract.  Update with real
  introduction.}
...
\fxnote{Acknowledge Matt for work on BC}
...
\fxnote{ADD ANY NREL ACKNOWLEDGEMENTS NECESSARY HERE}
