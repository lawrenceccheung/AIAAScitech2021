...
measured targets from Archer et al \cite{archer2016predominance}.  

The Obukhov length $L_{Ob}$ can be calculated as
\begin{equation}
  L_{Ob} = -\frac{u_\tau^3 T_0}{\kappa g \langle \overline{w'T'} \rangle}
\end{equation}
where the $\kappa$=0.41 is the Kolmogorov constant, $g$ is the
gravitational acceleration, and $\langle \overline{w'T'} \rangle$ is the
horizontally and time-averaged temperature flux.  In this study we use
the same classification guidelines as Archer et al
\cite{archer2016predominance}, and identify cases where $100 < L_{Ob}
< 500$ as ``stable'', and cases where $5 < L_{Ob}<100$ as ``very stable''.
...
\begin{tabular}{ccccccc}
  \hline
  Code & Wind speed & TI      &  $\alpha$  &   $u_\tau$  &  Obukhov  $L_{Ob}$ & Stability \\
  \hline
  AMRWind & 5m/s      & 0.0483 &  0.166 &  0.157 m/s  &  52.5 m   & Very stable\\
  AMRWind & 10m/s     & 0.0506 &  0.160 &  0.319 m/s  &  57.2 m   & Very stable\\
  AMRWind & 15m/s     & 0.0550 &  0.118 &  0.511 m/s  & 131.3 m   & Stable \\
  \hline
\end{tabular}
\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[hbt!]
  \centering
  \includegraphics[width=2.5in]{figures/snapshots/05ms/velh_mag_z20.png}
  \includegraphics[width=2.5in]{figures/snapshots/05ms/velz_z20.png} \\
  
  \includegraphics[width=2.5in]{figures/snapshots/10ms/velh_mag_z20.png}
  \includegraphics[width=2.5in]{figures/snapshots/10ms/velz_z20.png} \\
  
  \includegraphics[width=2.5in]{figures/snapshots/15ms/velh_mag_z20.png}
  \includegraphics[width=2.5in]{figures/snapshots/15ms/velz_z20.png} \\
...
\begin{figure}[hbt!]
  \centering
  \includegraphics[height=2.0in]{figures/snapshots/05ms/velh_mag_side.png} \\

  \includegraphics[height=2.0in]{figures/snapshots/10ms/velh_mag_side.png} \\

  \includegraphics[height=2.0in]{figures/snapshots/15ms/velh_mag_side.png} \\
...
\begin{figure}[hbt!]
  ...
  \caption{Comparison of the horizontal wind speed and wind direction
    profile for the stable 5m/s, 10m/s, and 15m/s boundary layers. }
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[hbt!]
  ...
  \caption{Comparison of the turbulence intensity and temperature
    profile for the stable 5m/s, 10m/s, and 15m/s boundary layers. }
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
