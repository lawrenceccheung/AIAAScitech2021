...
\begin{figure}%[hbt!]
  ...
  \caption{\label{fig:GridStudyRij} Calculation of the averaged
    ...
    \rangle$ coefficients at $z$=20m for LES of stable 5m/s case with
...
z=20m, the wind speed and wind shear are close to an exact match
...
\begin{figure} %[hbt!]
  ...
  \caption{\label{fig:CompareAMRvsNaluWind_WSDir} Comparison of
    ...
    horizontal line corresponds to the measurement height z=20m. }
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[hbt!]
  ...
  \caption{ \label{fig:SnapshotsZ20} Snapshots of the horizontal
    ...
    simulations at height z=20m, for the AMR-Wind calculation of the
...
and 10 m/s cases showed minimal shear at higher elevations (figure \ref{CompareAMRallWS}).  The
...
\begin{figure}[hbt!]
  ...
  \caption{ \label{fig:AllStabilityRij} Calculation of the averaged
    ...
    coefficient at $z$=20m for all ABL stability cases and windspeeds.}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
