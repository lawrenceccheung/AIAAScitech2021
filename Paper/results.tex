...
In comparison, the same case for Nalu-Wind takes 3.404 seconds per time step which
...
implementation. The most significant difference between the two solvers is that AMR-Wind uses structured grids
whereas Nalu-Wind uses unstructured grids. There is a lot of computational overhead with storing
