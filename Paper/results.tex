...
\begin{tabular}{ccccc}
  ...
  \hline
  Nalu-Wind coarse  &  10.0  & 10.0   & 2.5 & 1.5 km $\times$ 1.5km $\times$ 1.0 km  \\
  Nalu-Wind medium  &   5.0  &  5.0   & 2.5 & 1.5 km $\times$ 1.5 km $\times$ 1.0 km  \\
  Nalu-Wind fine    &   2.5  &  2.5   & 2.5 & 1.0 km $\times$ 1.0 km $\times$ 1.0 km  \\
...
mesh directions, the grid size is defined as $\Delta = \sqrt{2}\cdot \textrm{dx}$.
...
\fxnote{OK for temporal resolution}
...
as well as the neutral and unstable ABL computations from the previous study in
Cheung et al. \cite{cheung2020large}, we can examine the influence of wind speed and
...
\fxnote{Explain why AMR-Wind only}
From AMR-Wind calculations of the stable ABL at 5 m/s, 10 m/s, and
15 m/s, a number of quantities can be computed to compare with the
...
\begin{figure}[hbt!]
  ...
  \begin{tikzpicture}
    ...
    \node[align=left] at (1in, 4.50in){(a) horizontal vel, 5 m/s};
    ...
    \node[align=left] at (4.25in, 0in){(f) vertical vel, 15 m/s};
...
\begin{figure}[hbt!]
  ...
  \caption{ \label{fig:CompareAMRallWS} Comparison of the horizontal
    wind speed and wind direction profile for the stable 5 m/s, 10 m/s,
    and 15 m/s boundary layers. }
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[hbt!]
  ...
  \caption{ \label{fig:CompareAMRallTTI} Comparison of the turbulence
    intensity and temperature profile for the stable 5 m/s, 10 m/s, and
    15 m/s boundary layers. }
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
